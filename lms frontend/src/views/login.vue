...
<template>
    <div class="w-full h-screen flex justify-center items-center">
        <div class="bg-white w-[90%] md:w-[60%] lg:w-[40%] flex flex-col justify-center items-center py-4 px-4 rounded-xl shadow-2xl">
            ...
            <form action="#" class="flex flex-col w-full mt-7">
                <label for="username" class="text-sm md:text-lg lg:text-lg font-bold">Username</label>
                <input type="text" name="username" placeholder="Masukan username anda" class="text-sm md:text-lg lg:text-lg py-1 px-2 border-b-2 border-gray-300 outline-none focus:border-blue-500 transition-colors placeholder-gray-400">
                <label for="password" class="text-sm md:text-lg lg:text-lg font-bold">Password</label>
                <input type="password" name="password" placeholder="Masukan password anda" class="text-sm md:text-lg lg:text-lg py-1 px-2 border-b-2 border-gray-300 outline-none focus:border-blue-500 transition-colors placeholder-gray-400">
